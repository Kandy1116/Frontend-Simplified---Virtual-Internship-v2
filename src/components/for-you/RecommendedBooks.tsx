...
const RecommendedBooks: React.FC<RecommendedBooksProps> = ({ books }) => {
  return (
    <>
      <div className="for-you__title-wrapper">
      ...
      <div className="book-list">
        {books.map((book) => (
          <Link href={`/book/${book.id}`} key={book.id} className="book-card__link">
            {book.subscriptionRequired && <div className="book__pill book__pill--subscription-required">Premium</div>}
            ...
            <div className="recommended__book--details-wrapper">
              ...
              <div className="recommended__book--details">
                ...
                <div className="recommended__book--details-text">{book.rating}</div>
              </div>
            </div>
          </Link>
        ))}
